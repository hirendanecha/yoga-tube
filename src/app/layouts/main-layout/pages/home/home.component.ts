...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  editCommunity(data): void {
    ...
    modalRef.componentInstance.title = `Edit ${
      data.pageType === 'community' ? 'Instructors' : 'Page'
    } Details`;
  ...
  removeFromCommunity(id?): void {
    ...
    modalRef.componentInstance.title = `Leave ${this.communityDetails.pageType === "community" ? "Instructors" : "page"}`;
    modalRef.componentInstance.confirmButtonLabel = id ? 'Remove' : 'Leave';
    modalRef.componentInstance.cancelButtonLabel = 'Cancel';
    if (id) {
      modalRef.componentInstance.message = `Are you sure want to remove this member from ${this.communityDetails.pageType === "community" ? "Instructors" : "page"}?`;
    } else {
      modalRef.componentInstance.message = `Are you sure want to Leave from this ${this.communityDetails.pageType === "community" ? "Instructors" : "page"}?`;
    }
    modalRef.result.then((res) => {
      if (res === 'success') {
  ...
  deleteCommunity(): void {
    ...
    modalRef.componentInstance.title = `Delete ${this.communityDetails.pageType === "community" ? "Instructors" : "page"}`;
    modalRef.componentInstance.confirmButtonLabel = 'Delete';
    modalRef.componentInstance.cancelButtonLabel = 'Cancel';
    modalRef.componentInstance.message = `Are you sure want to delete this ${this.communityDetails.pageType === "community" ? "Instructors" : "page"}?`;
    modalRef.result.then((res) => {
      if (res === 'success') {
        this.communityService
  ...
  openAppointmentPopUp(): void {
    ...
    const data = {
      ...
      instructureProfileId: this.communityDetails?.profileId,
      instructureName: this.communityDetails.CommunityName,
    ...
    modalRef.result.then((res) => {
      if (res === 'success') {
        const data = {
          ...
          instructureProfileId: obj.instructureProfileId,
          profileId: obj.profileId,
          instructureName: obj.instructureName,
        };
